...
string select(string func_type) {
    ...
    if (func_type == "sum"){
        ...
        out = "the first vaule being greater than the second vaule is "; 
     }   
    else (out = "invalid funcation type\n");  
...
/** myPrint
 * @brief calls select() call out the output with the correct prompt 
 * 
...
int main()
 {       
    ...
    // intitialize 2 double parameters 
